...
Router.map(function() {
  ...
  this.route('submitProdutorPage', {path: '/submit/agricultor'});
  this.route('submitLojaPage', {path: '/submit/loja'});
  this.route('submitRestaurantePage', {path: '/submit/restaurante'});
