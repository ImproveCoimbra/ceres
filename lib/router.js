...
Router.map(function() {
  ...
  this.route('submitAgricultoresPage', {path: '/submit/agricultores'});
  this.route('submitLojasPage', {path: '/submit/lojas'});
  this.route('submitRestaurantesPage', {path: '/submit/restaurantes'});
